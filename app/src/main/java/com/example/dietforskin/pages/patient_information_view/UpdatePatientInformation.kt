    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            if (updatePatientInformationViewModel.visibilityOfBottomPDFSheet.value) {
                BottomPDFSheet(updatePatientInformationViewModel = updatePatientInformationViewModel,
                    visibilityOfBottomPDFSheet = updatePatientInformationViewModel.visibilityOfBottomPDFSheet,
                    onDismissSheet = { updatePatientInformationViewModel.visibilityOfBottomPDFSheet.value = false })
            }
